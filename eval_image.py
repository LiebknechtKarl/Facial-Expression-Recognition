...
def detect_bounding_box(image):
    ...
    for (x, y, w, h) in faces:
        ...
        # print_max_emotion(x, y, image, 'neutral')
...
# image = cv2.imread('raf_dir_li/test/test_0_anger.jpg')
image = cv2.imread('/home/fu/Downloads/c18232cd-12ff-4f58-a8aa-5eb9394b98f4.png')
