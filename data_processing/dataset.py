...
def config(dataset):
    ...
    if dataset == 'RAF-DB':
        train_root = MAIN_PATH + '/datas/RAF-DB/basic/train'
        test_root = MAIN_PATH + '/datas/RAF-DB/basic/test'
        train_pd = pd.read_csv(MAIN_PATH + "/datas/RAF-DB/basic/train_labels_li.csv", sep=" ", header=None,
                               names=['ImageName', 'label'])
        test_pd = pd.read_csv(MAIN_PATH + "/datas/RAF-DB/basic/test_labels_li.csv", sep=" ", header=None,
                              names=['ImageName', 'label'])
        cls_num = 7
