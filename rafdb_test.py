...
def parse_args():
    ...
    parser.add_argument('--raf_path', type=str, default='/home/fu/Desktop/ubuntu_data/nlp/raw_data/data', help='Raf-DB dataset path.')
    ...
    parser.add_argument('--model_path', default = 'checkpoints/rafdb_epoch4_acc0.8732_bacc0.7842.pth')
